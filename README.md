# Classificadores PLN de ACH2118

Aqui você encontra um guia de **como rodar os modelos desta aplicação utilizando o Docker e  JupyterLab**, e ainda explicações/orientações de como essa *stack* funciona e como você pode rodar/desenvolver código.

Para informações de desenvolvimento e implementação deste projeto, leia o README que está no diretório **/python**.



## Tutorial: Como rodar esta aplicação

Este é um passo-a-passo para que você consiga rodar essa aplicação com o Docker localmente. 
